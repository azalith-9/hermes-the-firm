...
The shift this represents: from the agent-as-tool (you go to it) to the agent-as-coworker (it operates in the background, and brings you something).
...
Four of the twelve practice-area plugins ship as **cookbooks** deployable through the the agent API as managed agents:
...
The other eight plugins (Privacy Legal, Employment Legal, Regulatory Legal, AI Governance Legal, IP Legal, Law Student, Legal Clinic, Legal Builder Hub) are Hermes session-resident at launch. That lineup may expand.
...
| Lives in Hermes session on your machine | Runs in Anthropic-managed infra |
...
Managed agents inherit the privilege posture of the underlying the agent tier and the connectors they use. Two questions to answer before deploying a managed agent in privileged territory:
