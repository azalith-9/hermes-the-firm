...
```
hermes-the-firm:clearance "APEXLEAF for an outdoor apparel line, planned launch US + EU"
```

```
hermes-the-firm:clearance
```
...
Before running clearance, read `~/.hermes/plugins/config/hermes-the-firm/ip-legal/PRACTICE.md`. Pull:
...
Read `## Available integrations` from `~/.hermes/plugins/config/hermes-the-firm/ip-legal/PRACTICE.md`:
...
Per the decision posture in `~/.hermes/plugins/config/hermes-the-firm/ip-legal/PRACTICE.md`:
...
`~/.hermes/plugins/config/hermes-the-firm/ip-legal/matters/<matter-slug>/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.hermes/plugins/config/hermes-the-firm/ip-legal/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`
