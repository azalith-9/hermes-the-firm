...
The user typed `hermes-the-firm:clinic-customize`. They (usually the professor, sometimes
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:clinic-cold-start-interview`
...
5. **Close.**
   ...
   > run `hermes-the-firm:clinic-customize` anytime.
