...
1. Read `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md`. Confirm privacy practice is configured — if not, stop and direct to setup.
...
```
hermes-the-firm:privacy-use-case-triage "New feature that uses behavioral data to personalize content recommendations"
```
...
Before triaging, always read `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md`. The PIA trigger criteria, regulatory
...
>
> **Two choices:**
> - Run `hermes-the-firm:privacy-cold-start-interview` (2 minutes) to configure your profile, then I'll triage tailored to YOUR practice.
...
> "That was a generic run against default assumptions. Run `hermes-the-firm:privacy-cold-start-interview` to get output calibrated to YOUR practice — your regulatory footprint, your privacy policy commitments, your risk appetite. 2 minutes."
...
Read `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md` → `## PIA house style` → Trigger criteria. Apply them.
...
Read `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md` → `## Privacy policy commitments`. Check the proposed activity
...
`hermes-the-firm:pia-generation [activity]`
...
> required in addition to a PIA. Use `hermes-the-firm:aia-generation [activity]`
...
> Use `hermes-the-firm:launch-review` — it will detect the privacy component
