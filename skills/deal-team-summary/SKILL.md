...
- `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` → Deal team briefing (cadence, format, what the business reads)
- `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/deals/[code]/deal-context.md` → deal lead, timeline
- Current findings from diligence-issue-extraction output

## Audience tiers

Per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` — what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` cadence), lead with what changed:
