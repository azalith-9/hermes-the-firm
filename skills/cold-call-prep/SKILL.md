...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → class list, professors, learning style.
...
- `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → current classes, professors, learning style
...
- Professor (from ~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md class list — tone and focus vary by professor)
- Class / subject area
...
**Professor-specific flavor (from ~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md notes):**
...
- **case-brief:** if the student hasn't briefed the case yet, offer to run `hermes-the-firm:case-brief` before cold-call prep. A brief is a cold-call prep tool too.
- **socratic-drill:** if prep surfaces a weak spot in the subject (not just this case), follow with `hermes-the-firm:socratic-drill [subject]`.
...
- **Predict jurisdiction-specific niche questions.** If the professor has known hobby horses, capture them in ~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md class notes and the skill can weight accordingly; otherwise, it works from general patterns.
