...
2. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/_log.yaml` for portfolio cross-check.
3. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → risk calibration, landscape, demand-letter practice.
...
6. Write `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/[slug]/triage.md`. Copy or link incoming to `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/_log.yaml` — scan for related matters (same counterparty, overlapping counterparties via entity relationships, or matter type + recent date)
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → risk calibration (for merit assessment), landscape (is the sender a frequent adversary?), demand-letter practice (house tone and response defaults)
...
- **Leverage and pressure** — are they credibly prepared to sue? Do they have capacity? Are they a repeat-litigant adversary per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`?
...
- Standalone → leave in `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/`; no portfolio change.
