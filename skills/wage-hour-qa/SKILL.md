...
1. Load `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint.
...
`~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint. If the question doesn't specify a
...
- "Can we classify this person as a contractor?" — Route to
  `hermes-the-firm:worker-classification` if the facts are not already clear.
