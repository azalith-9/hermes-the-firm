...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → class, professor, exam format, syllabus.
...
7. Write `~/.hermes/plugins/config/hermes-the-firm/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Framed as weighting heuristic, not prediction.
...
- `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → current classes, exam formats, syllabus if captured
...
Write to `~/.hermes/plugins/config/hermes-the-firm/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Versioned — if the student gets another past exam mid-semester, re-run and append.
