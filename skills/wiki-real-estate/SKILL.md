---
name: wiki-real-estate
description: Use when advising on real estate law across MENA — covering title registration, lease structures, mortgage and security, strata and jointly owned property, major regulatory bodies (RERA Dubai, ADM Abu Dhabi, GCAA KSA), and the distinctive features of Lebanon's old-rent (ijar qadim) vs new-rent regime. Reach for this skill when the user asks about property law, lease agreements, title registration, real estate transactions, or property regulation in UAE, KSA, Lebanon, or Egypt.
license: MIT
metadata: " id: wiki.real-estate category: wiki practice_area: real-estate-law jurisdictions: [UAE, KSA, LB, EG, DIFC, ADGM] priority: P3 intent: [__wiki__, real-estate-law, title, lease, mortgage, RERA, Lebanon-rent, KSA-property] related: [wiki-legal, wiki-personal-finance-real-estate, wiki-finance, wiki-geopolitics] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
