...
1. Load `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → jurisdiction, practice area.
...
```
hermes-the-firm:research-start "habitability defense to nonpayment eviction in [State]"
```
...
`~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → jurisdiction (state), practice areas.
...
1. Read `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → `## Seed documents`. Identify any item whose purpose or filename matches the research area (e.g., "Alameda UD filing guide" for a UD habitability question; a redacted sample case file in the same practice area; a prior memo on the same issue).
