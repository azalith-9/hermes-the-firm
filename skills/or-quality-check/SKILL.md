...
> the surface — they don't tell the user whether the underlying
> legal position is sound. Verify current rules before filing;
...
1. **Run the checker:**
   ...
   ```bash
   python3 "{plugin root}/scripts/format-check.py" "<path>"
   ```
