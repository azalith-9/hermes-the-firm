# Online Sources — Oregon Consumer-Debt Research

Canonical URLs for Oregon and federal consumer-debt research.
web_search only; per the plugin's safety policy.
...
- **ORS 697** (Collection Agency Registration Act):
  https://www.oregonlegislature.gov/bills_laws/ors/ors697.html

## Oregon court rules

- **ORCP** (Council on Court Procedures):
...
- **OAR 441** (DCBS — collection agencies):
  https://secure.sos.state.or.us/oard/

## Oregon DCBS — collection-agency registration

- **Registration database (searchable)**:
...
- **CourtListener — Oregon Supreme Court**:
  https://www.courtlistener.com/?type=o&court=or
- **CourtListener — Oregon Court of Appeals**:
  https://www.courtlistener.com/?type=o&court=orctapp
- **Google Scholar — Oregon courts**:
...
- **FDCPA (15 USC § 1692 et seq.)**:
  https://uscode.house.gov/view.xhtml?req=granuleid%3AUSC-prelim-title15-chapter41-subchapter5&edition=prelim
...
- **TILA (15 USC § 1601 et seq.)**:
  https://uscode.house.gov/view.xhtml?req=granuleid%3AUSC-prelim-title15-chapter41-subchapter1&edition=prelim
- **eCFR (12 CFR — banking regs)**:
  https://www.ecfr.gov/current/title-12
- **Reg F (12 CFR pt 1006)**:
  https://www.ecfr.gov/current/title-12/chapter-X/part-1006

## Federal case law

- **CourtListener — 9th Circuit**:
  https://www.courtlistener.com/?type=o&court=ca9
- **CourtListener — District of Oregon**:
  https://www.courtlistener.com/?type=o&court=ord

## CFPB

- **CFPB main**:
  https://www.consumerfinance.gov/
- **CFPB Reg F implementing rules**:
...
- **CLEAR Legal Hotline**: (800) 520-5292
- **OSB Lawyer Referral**:
...
## Authoritative scholarship and treatises

- **National Consumer Law Center** (NCLC) publishes practice
  manuals on FDCPA, UTPA-parallel state laws, and chain of
  title:
  https://www.consumerlaw.org/
- **CFPB Manual** (compliance manual; not binding but
  persuasive):
  https://www.consumerfinance.gov/policy-compliance/
  compliance/compliance-resources/

## State-specific debt-collection resources

- **National Association of Consumer Advocates** (NACA):
  https://www.consumeradvocates.org/
- **Oregon Consumer Justice** (formerly Oregon Consumer
  League):
  https://oregonconsumerjustice.org/

## Court database access for chain-of-title research

If researching a specific debt buyer's chain of title:
...
- `or-law-references/references/legal-data-apis.md` —
  programmatic access
- `or-fact-check` — citation verification using these URLs
