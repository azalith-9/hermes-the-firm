...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → outline/brief preferences.
...
`~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → outline/brief preferences (format, depth), learning style.
...
Per the student's format in `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md`. If none captured, default:
...
Per `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` — some students want one-line briefs (rule + cite), some want full treatment. Match their format.
