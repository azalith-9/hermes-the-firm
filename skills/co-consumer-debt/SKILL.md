...
- `references/fdcpa.md` — FDCPA § 1692 et seq. annotated (verbatim text in
  the firm's open-us-law corpus via `us-statute-lookup`)
- `references/reg-f.md` — Regulation F at 12 C.F.R. pt. 1006 (verbatim text
  in the firm's open-us-law corpus via `us-statute-lookup`)
