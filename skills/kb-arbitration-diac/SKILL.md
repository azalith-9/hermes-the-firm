...
license: MIT
metadata: " id: kb.arbitration-DIAC category: kb practice_area: Dispute Resolution — Arbitration jurisdictions: [UAE, DIFC] priority: P0 intent: [arbitration, DIAC, dispute resolution, UAE, commercial arbitration, enforcement] related: [kb-arbitration-difc-lcia, kb-arbitration-icc, kb-arbitration-lcia, kb-corporate-law-uae, draft-arbitration-clause] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
### Recommended clause (DIFC seat, English, three arbitrators)
