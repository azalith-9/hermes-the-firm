...
The user typed `hermes-the-firm:builderhub-customize`. They want to change something
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:builderhub-cold-start-interview`
...
6. **Close.**
   ...
   > run `hermes-the-firm:builderhub-customize` anytime.
