...
1. Load `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → jurisdiction, practice areas, warning-day cadence.
2. Use the workflow below.
3. Route by flag:
   - `--add`: capture case, type, description, due date, source, owner. Write to `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/deadlines.yaml`. Check for duplicates first.
...
- `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → jurisdiction, practice areas, deadline warning days (default 14/7/3/1), supervising attorneys
- `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/deadlines.yaml` — the ledger

**Jurisdiction assumption.** Deadline calculations and warning thresholds assume the jurisdiction set in PRACTICE.md. Deadlines, tolling rules, computation-of-time rules, and local court practices vary materially by jurisdiction and by specific court. If a matter involves a different state, a specific court's local rules, or a federal vs. state forum question, confirm the deadline against the governing rule with your supervisor before relying on it.
...
Read `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/deadlines.yaml`. Produce:
...
Per `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` deadline warning days. Default 14, 7, 3, 1.
...
- **`/status`:** the status skill reads `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/deadlines.yaml` for the relevant case and includes upcoming deadlines in its output.
