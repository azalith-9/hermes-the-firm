---
name: kb-criminal-procedure-ksa
...
license: MIT
metadata: " id: kb.criminal-procedure-KSA category: kb practice_area: Criminal Law & Procedure jurisdictions: [KSA] priority: P2 intent: [Saudi criminal procedure, criminal law KSA, arrest, detention, Public Prosecution, Sharia law, Saudi courts] related: [kb-aml-fatf-mena, kb-criminal-procedure-uae, kb-corporate-law-ksa] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
1. **BIP refers case to court** — indictment filed
2. **Initial hearing** — accused formally charged; right to plead
3. **Evidence phase** — BIP presents evidence; defence challenges
4. **Witness examination** — oral testimony; cross-examination in adversarial style but adapted to Islamic procedural tradition
5. **Closing arguments** — BIP + defence
6. **Judgment** — written; may be rendered immediately after hearing or within a period
7. **Sentencing** — follows judgment
