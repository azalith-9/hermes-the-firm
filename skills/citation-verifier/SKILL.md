...
<!--
HERMES PORT NOTE
Mechanically ported into hermes-the-firm from HAQQ Legal AI's master-claude-for-legal (MIT), source 'citation-verifier.md'.
...
- If the verification reveals the output relies on training-data recall rather than grounded retrieval, surface this. The output likely needs to be redone in a Hermes session session with proper retrieval connectors.
...
Built to address the over-2,000 documented court filings containing hallucinated citations as of 2026, referenced by Mark Pike in the *the agent for Legal Teams* webinar. The two-mode framework (Mode 1 fabrication, Mode 2 paraphrase-as-quote) is HAQQ's editorial expansion. MIT licensed. Part of master-hermes-the-firm: github.com/sboghossian/master-hermes-the-firm
