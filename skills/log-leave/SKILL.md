...
Adds a new leave entry to `~/.hermes/plugins/config/hermes-the-firm/employment-legal/leave-register.yaml` with the minimum
...
1. Read `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md`, look up the applicable leave
...
5. Write a new entry to `~/.hermes/plugins/config/hermes-the-firm/employment-legal/leave-register.yaml` using the leave register
