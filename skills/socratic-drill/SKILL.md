...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → learning style, classes, weak areas.
...
`~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → learning style (drill-me vs explain-to-me — this skill is drill-me by design, but tone adjusts), weak areas, current classes.

## The drill

### Step 1: Pick the topic

User names it, or pull from weak areas in `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md`. If they keep avoiding a subject, that's the one to drill.
...
1. The student has actually uploaded materials (notes, outlines, case briefs, flashcards) referenced in `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → Seed materials, and
