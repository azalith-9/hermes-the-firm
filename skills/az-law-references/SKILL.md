...
practice. Other skills in the `us-az-legal-corpus` plugin point here for rule
...
The Arizona-specific corpora (`court-rules/`, `az-statutes-debt/`) and the
eight curated `*.md` index files live physically under this skill. In the
upstream `claude-legal` plugin three federal corpora (`federal-debt-laws/`,
