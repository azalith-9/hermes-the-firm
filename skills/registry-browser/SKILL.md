...
1. Load `~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → watched registries.
...
`~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → watched registries list.
...
2. Show what's in it
3. Add to `~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → watched registries on confirmation
