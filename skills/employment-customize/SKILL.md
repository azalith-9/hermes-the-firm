...
The user typed `hermes-the-firm:employment-customize`. They want to change something
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:employment-cold-start-interview`
...
6. **Close.**
   ...
   > run `hermes-the-firm:employment-customize` anytime.
