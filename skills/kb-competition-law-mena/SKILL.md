...
license: MIT
metadata: " id: kb.competition-law-MENA category: kb practice_area: Competition Law jurisdictions: [MENA, UAE, KSA, EG, LB] priority: P0 intent: [competition law, merger control, antitrust, cartel, abuse of dominance, MENA] related: [kb-corporate-law-uae, kb-corporate-law-ksa, draft-distribution-agreement, review-commercial-contract] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
1. Do the parties' combined revenues/assets meet any filing threshold in any MENA jurisdiction?
2. Is the target active in any MENA market?
3. Are there any sector-specific filing requirements (financial services, media, telecoms)?
4. What is the standstill obligation — can you close before clearance?
5. What are the review periods (Phase I, Phase II)?
6. Are there remedy discussions to plan for?
