...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.hermes/plugins/config/hermes-the-firm/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → current classes, exam formats, outline locations, learning style
- `~/.hermes/plugins/config/hermes-the-firm/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Append to `~/.hermes/plugins/config/hermes-the-firm/law-student/irac-sessions/[student]/tracker.md`:
...
- "Your organization is strong; the gap is at rule-accuracy. Drill black-letter rules with hermes-the-firm:flashcards."
...
- **legal-writing:** for non-IRAC writing (memos, briefs, papers), use `hermes-the-firm:legal-writing` instead
- **socratic-drill:** if issue-spotting is the recurring gap, `hermes-the-firm:socratic-drill` on issue-spotting for the subject before more essay practice
