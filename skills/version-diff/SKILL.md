...
<!--
HERMES PORT NOTE
Mechanically ported into hermes-the-firm from HAQQ Legal AI's master-claude-for-legal (MIT), source 'version-diff.md'.
...
This skill answers Aishwarya Belle's webinar question: *"As a transactional lawyer, I struggle with tracking which version of the document reflects changes made by multiple parties. Can the agent give a comparison for that?"*
...
- Optionally: a PRACTICE.md or matter-context file describing the parties and the negotiation history (who returned which draft when)
...
4. If a PRACTICE.md or context file is present, read it for negotiation history.
...
Starter version. MIT licensed. Part of master-hermes-the-firm: github.com/sboghossian/master-hermes-the-firm
