...
description: >
  ...
  per the trust level in `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md`. Use when user says "send to Luminance",
...
If `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` says no AI tool → this skill is a no-op. Everything goes through diligence-issue-extraction directly.
...
- Specify extraction targets per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` (which clause types)
- Note the materiality threshold so tool output can be filtered

### Step 2: Load (or instruct the loader)

Per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` — who loads. If it's you, generate the load instructions. If it's someone else, generate the request:
...
- Exclusivity
- [etc. per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md`]
...
**"Use as-is":** Ingest directly into diligence findings. (Only if `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` says this — it's rare.)
...
**Trust level:** [per `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md`]
...
- It doesn't replace the tool's output with its own judgment entirely — if `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` says spot-check 10%, check 10%, not 100%.
- It doesn't decide the trust level — that's in `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md`, set at cold-start based on the team's experience with the tool.
