...
practice. Other skills in the `us-tn-legal-corpus` plugin point here for
...
In **hermes-the-firm** the federal/UCC text is not bundled but served by the
firm's open-us-law corpus via `us-statute-lookup` — see
