...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → Seed materials, or an earlier section of the outline being extended), and
...
`~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → outline preferences (format, depth, existing outlines location).
