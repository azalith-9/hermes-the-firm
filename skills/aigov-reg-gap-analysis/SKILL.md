...
1. Read `~/.hermes/plugins/config/hermes-the-firm/ai-governance-legal/PRACTICE.md`. Confirm regulatory footprint and use case registry are populated.
...
4. Extract requirements. Diff against current state in `~/.hermes/plugins/config/hermes-the-firm/ai-governance-legal/PRACTICE.md`.
...
```
hermes-the-firm:aigov-reg-gap-analysis "EU AI Act high-risk provisions"
```
...
(per `~/.hermes/plugins/config/hermes-the-firm/ai-governance-legal/PRACTICE.md` — use case registry, vendor positions, impact assessment practices,
...
**We currently:** [what `~/.hermes/plugins/config/hermes-the-firm/ai-governance-legal/PRACTICE.md` / AI policy / use case registry / assessment
practice shows]
