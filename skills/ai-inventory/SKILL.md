...
1. **Read the config.** Read
   ...
   to `hermes-the-firm:aigov-cold-start-interview` first.
...
`hermes-the-firm:ai-inventory classify <id>`."
...
2. "Want to run `hermes-the-firm:aia-generation` to produce a full
   impact assessment?"
...
`hermes-the-firm:aia-generation` for the formal impact assessment
if needed.
