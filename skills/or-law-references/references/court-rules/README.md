...
python3 scripts/pull_oregon_rules.py \
  --workers 8 \
  --manifest plugins/us-or-legal-corpus/skills/or-law-references/references/court-rules/_manifest.json
```
...
For ad hoc extraction without the script, use web_search against
