...
license: MIT
metadata: " id: prompt-pack.patent-license-agreement category: prompt-pack practice_area: ip-licensing priority: P2 intent: [drafting, patent-license-agreement] related: - prompt-pack-ip-assignment-agreement - prompt-pack-ip-due-diligence-checklist - prompt-pack-open-source-compliance-review - prompt-pack-nda-strength-check - heuristic-always-state-jurisdiction-first source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
