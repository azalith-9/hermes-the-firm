...
1. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/matter.md` + `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/_log.yaml` — structured row
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/matter.md` — narrative intake
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/history.md` — event log
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` — risk calibration (so "risk: high" means something specific, not generic)
...
> "I don't see [matter slug] in the matter log. Run `hermes-the-firm:matter-intake` first so the conflicts check runs and the matter workspace is set up. I won't build a briefing on a matter that hasn't been intaken — the conflicts check is the gate."
...
If `last_updated > 30 days ago`: flag at the top AND suggest running `hermes-the-firm:matter-update [slug]` after the meeting to capture whatever's discussed.
