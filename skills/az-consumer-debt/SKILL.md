...
2021; call-frequency, validation-notice content, time/place rules). Federal text lives in the firm's
open-us-law corpus — quote it via `us-statute-lookup` (`15 USC 1692`, `15 USC 1681`, `12 CFR 1006`);
see `az-law-references` → `references/federal-layer.md`.
...
status); FCRA § 605B identity-theft block if applicable (see the federal
layer — verbatim text in the firm's open-us-law corpus via `us-statute-lookup`).
...
- `references/fdcpa.md` — FDCPA federal layer; verbatim text in the firm's
  open-us-law corpus via `us-statute-lookup` (see `az-law-references` →
  `references/federal-layer.md`)
