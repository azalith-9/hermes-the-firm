...
license: MIT
metadata: " id: review.MSA-deep-review category: review jurisdictions: [UAE, DIFC, ADGM, KSA, LB, EG, UK, US, EU, FR] priority: P0 intent: [msa review, review master services, services agreement, commercial contract review, comprehensive review] related: [review-indemnification-balance, review-liability-cap-reasonableness, review-ip-ownership-clarity, review-risk-flagging, review-missing-clauses, draft-msa] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
