...
practice. Other skills in the `us-co-legal-corpus` plugin point here for
...
- `references/federal-layer.md` — routing note for the federal-law corpus and
  Model UCC text (both served by the open-us-law corpus via `us-statute-lookup`)
