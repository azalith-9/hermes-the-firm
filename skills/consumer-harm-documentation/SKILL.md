...
description: >
  ...
  health data into a harm declaration with the agent). Produces
...
`us-federal-debt-corpus` plugin. Thin-adapted: the federal-debt / UCC
references it pointed at are NOT bundled here — that text is served by
the firm's open-us-law corpus via `us-statute-lookup` (see
`us-law-coverage.json` / `us-statute-lookup` skill).
-->
...
Statutory text: [`../../FCRA — 15 U.S.C. § 1681 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)`](../../FCRA — 15 U.S.C. § 1681 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`))
...
- **the agent as a drafting aid:** wearable health-data exports can be summarized and folded into a
...
- **ECOA § 1691(d) + Reg B § 1002.9** —
  [`../../ECOA — 15 U.S.C. § 1691 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)`](../../ECOA — 15 U.S.C. § 1691 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)) /
  [`../../Reg B — 12 C.F.R. pt. 1002 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)`](../../Reg B — 12 C.F.R. pt. 1002 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)).
...
- **Reg V §§ 1022.70–1022.75 (12 CFR Part 1022)** —
  [`../../Reg V — 12 C.F.R. pt. 1022 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)`](../../Reg V — 12 C.F.R. pt. 1022 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)).
...
- **FDCPA** —
  [`../../FDCPA — 15 U.S.C. § 1692 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)`](../../FDCPA — 15 U.S.C. § 1692 (verbatim text in the firm's open-us-law corpus via `us-statute-lookup`)) — for
