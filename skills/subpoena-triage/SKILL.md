...
3. If grand jury → stop, escalate per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`. Otherwise continue.
4. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/_log.yaml` for cross-check. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → landscape, privilege conventions, escalation norms.
...
7. Write `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/[slug]/triage.md`. Copy or link subpoena to `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/_log.yaml` — for related matter lookup and legal hold status
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → landscape (regulators we deal with), house privilege conventions, escalation norms
...
- Privilege log will be required — flag the format per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`
...
Output: `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/inbound/[slug]/triage.md`.
...
**Privilege log format required:** [per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`]
...
**Before responding to the subpoena (serving objections, producing documents, appearing for deposition, or filing a motion to quash — any substantive response to the issuing party or court):** Read `## Who's using this` in `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`. If the Role is Non-lawyer:
...
- If classified as **grand jury subpoena** → stop, flag for escalation per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`, do not proceed with standard triage.
