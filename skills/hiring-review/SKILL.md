...
1. Load `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint, hiring review triggers, restrictive covenant policy.
...
`~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint, hiring review triggers, restrictive
...
Check the jurisdiction table in `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` for this state/country. If it's
...
Per `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` restrictive covenant policy: does this hire even get one?
...
Check the `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` table for this jurisdiction. Common categories to
...
**Before producing a "Clear to send" recommendation or a final offer letter for signature:** Read `## Who's using this` in `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md`. If the Role is **Non-lawyer**:
