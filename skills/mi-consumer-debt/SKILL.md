...
furnisher / re-aging / dispute issues. Federal text lives in the firm's open-us-law corpus —
quote it via `us-statute-lookup` (`15 USC 1692`, `15 USC 1681`, `12 CFR 1006`); see
`mi-law-references` → `references/federal-layer.md`.
...
- `references/fdcpa.md`, `references/reg-f.md`, `references/fcra.md` — federal layer
  (FDCPA/FCRA/Reg-F text served by the open-us-law corpus via `us-statute-lookup`; see
  `mi-law-references` → `references/federal-layer.md`)
