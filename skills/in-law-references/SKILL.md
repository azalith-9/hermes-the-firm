...
description: >
  ...
  corpora for the us-in-legal-corpus plugin: Indiana Trial Rules,
...
us-in-legal-corpus skills cite. Treat this as the **library** that the
...
The federal/UCC primary-law text is served by the firm's open-us-law
corpus via the `us-statute-lookup` skill (not bundled here — see
`references/federal-layer.md`). Sources commonly cited from it:
...
Every other us-in-legal-corpus skill cites this reference catalog by
