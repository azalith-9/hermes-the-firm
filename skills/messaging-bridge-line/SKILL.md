...
license: MIT
metadata: " id: messaging.bridge-line category: messaging priority: P0 intent: [messaging, positioning, brand, B2C, B2B, bridge, copy] related: [messaging-allowed-claims-consumer, messaging-allowed-claims-lawyer, messaging-banned-claims-consumer, messaging-banned-claims-lawyer, messaging-compliance-checker] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
1. **Consumers** — individuals navigating legal situations without a lawyer present, who need understanding, orientation, and preparation
2. **Legal professionals** — lawyers and in-house counsel who need faster, more consistent, more comprehensive legal work product
