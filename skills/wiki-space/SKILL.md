---
name: wiki-space
description: Use when a user asks about space law, satellite operations, launch licensing, spectrum regulation, sovereign space programs, or space commerce transactions in the MENA region (particularly UAE and Saudi Arabia). Provides a reference on the international and national legal framework governing space activities, including licensing regimes, liability, and commercial space venture considerations.
license: MIT
metadata: " id: wiki.space category: wiki jurisdictions: [UAE, KSA, __multi__] priority: P3 intent: [__wiki__, space law, launch licensing, satellite, space commerce, UAE space, KSA space] related: [wiki-tech, wiki-startup, wiki-vc-startups, research-jurisdiction-comparison] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
|--------|------|----------------|
| Outer Space Treaty (OST) | 1967 | Space is the "province of all mankind"; no national appropriation; states responsible for national activities; no weapons of mass destruction in orbit |
| Rescue Agreement | 1968 | Astronaut rescue obligations |
| Liability Convention | 1972 | Absolute liability for surface damage; fault-based for damage in space; inter-state claims mechanism |
| Registration Convention | 1976 | States must register space objects with UN; national registries required |
| Moon Agreement | 1979 | Moon resources are "common heritage of mankind" — notably not ratified by major spacefaring nations |
...
Licensing process:
1. Application to UAESA with technical dossier
2. Regulatory assessment (typically 60–90 days)
3. Coordination with Telecommunications and Digital Government Regulatory Authority (TDRA) for spectrum
4. License issued with conditions; annual reporting required
...
1. **Authorization from the home state** of the operator (under OST, states must authorize and supervise national activities)
2. **Launch site licensing** — the launch site country has its own licensing process (US FAA/AST for US launches; Arianespace/ESA rules for Kourou; Russian Roscosmos; SpaceX launches require FAA license)
3. **Export licenses** — US-origin satellite technology is subject to ITAR (International Traffic in Arms Regulations) and EAR; requires State Department / Commerce Department licenses for export to any country
