...
`us-ca-legal-corpus` plugin. Thin-adapted: the federal/UCC corpora it
...
`ca-law-references` skill, references/federal-layer.md).
-->
...
See the firm's open-us-law corpus via `us-statute-lookup` for the full annotated FDCPA.
...
See the firm's open-us-law corpus via `us-statute-lookup` for the full annotated Reg F.
...
- `references/fdcpa.md` — FDCPA section-by-section (verbatim text in the
  firm's open-us-law corpus via `us-statute-lookup`)
- `references/reg-f.md` — Regulation F annotated (verbatim text in the
  firm's open-us-law corpus via `us-statute-lookup`)
