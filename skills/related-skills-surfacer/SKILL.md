...
1. Load `~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → practice profile.
...
`~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → practice profile, installed skills (don't suggest what's already installed).
...
If strong match:
> 💡 The community has a skill for this: **[name]** from [registry] — "[description]". `hermes-the-firm:skill-installer [name]` to try it.
...
Per `~/.hermes/plugins/config/hermes-the-firm/legal-builder-hub/PRACTICE.md` → new skill notifications:
