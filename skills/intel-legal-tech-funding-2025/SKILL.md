...
description: Use when discussing venture capital and private equity investment in legal technology, 2025 funding records, notable financing rounds (Harvey, Spellbook, Legora, CoCounsel, HAQQ), or the signal that legal tech funding sends about market maturity and competitive intensity. Covers the $6B 2025 record year, Q1 2026 acceleration, and what the funding landscape means for platform strategy and fundraising.
license: MIT
metadata: " id: intel.legal-tech-funding-2025 category: intel jurisdictions: [__multi__, US, UK, EU] priority: P1 intent: [__intel__, legal-tech-funding, VC, Harvey, Spellbook, Legora, CoCounsel, investment-landscape] related: [intel-legal-ai-cagr, intel-market-size-global, intel-harvey-spectre-agent-update, intel-axiom-x-harvey-deal, intel-market-segmentation] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
|---|---|---|
| **2025 (full year)** | **~$6B** | Record year; roughly double 2022 levels |
| **Q1 2026** | **~$2.3B** | Annualized pace = ~$9B+; acceleration continuing |
| 2024 (full year) | ~$4–4.5B | Harvey Series C anchored the year |
| 2023 (full year) | ~$2.5B | Thomson Reuters CoCounsel acquisition dominated |
| 2022 (full year) | ~$1.5B | Pre-LLM era; slower pace |
...
|---|---|---|---|---|
| Harvey | Series C | **$300M** | 2024 | BigLaw AI; OpenAI-backed |
| Spellbook (Rally) | Series B (est.) | **$30M+** | 2024 | Word add-in; contract drafting |
| Legora | Series A | **€30M (~$33M)** | 2024 | European contract review; Sweden |
| CoCounsel | Acquisition (Thomson Reuters) | **$650M** | 2023 | Legal research AI; acquired from Casetext |
| HAQQ (Louis) | Seed | **$3M** | 2024 | MENA-focused legal AI |
| Ironclad | Series D+ (ongoing) | $300M+ cumulative | — | Contract lifecycle management |
| EvenUp | Series C | $135M | 2024 | Personal injury litigation AI |
| Lexion | Series C | $100M+ | 2023–2024 | Contract management + AI |
...
Harvey's $300M Series C at a reported $1.5B+ valuation in 2024 established legal AI as a legitimate venture category. Before this, legal tech was often seen as a slow-growth, PE-preferred market.

### 2. Enterprise dominance
The largest rounds are going to enterprise-focused platforms (BigLaw, large in-house teams). Consumer legal AI ($3M HAQQ seed) is much earlier stage — the access-to-justice mission has not yet attracted comparable capital.

### 3. MENA undercapitalized
MENA legal AI is dramatically underfunded relative to market opportunity:
- US/UK/EU legal AI: $5.5B+ in 2025 funding
- MENA legal AI: <$50M total investment to date
...
- The $3M seed positions Louis for a Series A in 2025–2026 if product-market fit in MENA is demonstrated
- Series A comparables in legal AI: $15–30M at $60–150M pre-money (based on Legora, Spellbook, and similar)
...
- Q1 2026 $2.3B is a single-quarter figure; full-year 2026 pace depends on macroeconomic conditions
