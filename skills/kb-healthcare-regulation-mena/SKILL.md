---
name: kb-healthcare-regulation-mena
...
license: MIT
metadata: " id: kb.healthcare-regulation-MENA category: kb practice_area: Healthcare & Life Sciences Law jurisdictions: [KSA, UAE, LB, EG, MENA] priority: P1 intent: [healthcare, regulation, MENA, facility-licensing, health-insurance, telehealth, medical-liability] related: [kb-data-privacy-ksa-pdpl, kb-data-privacy-uae-pdpl, kb-data-privacy-gdpr, kb-employment-law-ksa, kb-employment-law-uae, kb-ip-mena] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
