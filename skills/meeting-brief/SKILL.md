...
<!--
HERMES PORT NOTE
Mechanically ported into hermes-the-firm from HAQQ Legal AI's master-claude-for-legal (MIT), source 'meeting-brief.md'.
...
This skill is the meeting prep version of the workflow Maggie Russo demoed in the *the agent for Legal Teams* webinar.
...
Inspired by Maggie Russo's live demo of the meeting brief skill in the *the agent for Legal Teams* webinar (April 2026, Anthropic). Generalized starter version. MIT licensed. Part of master-hermes-the-firm: github.com/sboghossian/master-hermes-the-firm
