...
3. **Fetch canonical sources** for each citation (prefer
   web_search; respect the web-content-restrictions — do **not**
   fall back to alternative fetch methods if web_search declines)
...
If web_search fails for a canonical URL:
