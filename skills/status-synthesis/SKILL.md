...
<!--
HERMES PORT NOTE
Mechanically ported into hermes-the-firm from HAQQ Legal AI's master-claude-for-legal (MIT), source 'status-synthesis.md'.
Tool names and paths rewritten to Hermes equivalents where needed.
-->
...
This is the "Friday newsletter" pattern Mark Pike closed the *the agent for Legal Teams* webinar with. His specific instruction stays in this skill verbatim: **don't be sycophantic and just tell me we did your work. Show me what's actually impactful based on what other people are saying.**
...
Built from Mark Pike's "Friday newsletter" example in the *the agent for Legal Teams* webinar (April 2026, Anthropic). The non-sycophantic instruction is verbatim from Mark. The Pamela-tracker daily variant is in the same lineage. MIT licensed. Part of master-hermes-the-firm: github.com/sboghossian/master-hermes-the-firm
