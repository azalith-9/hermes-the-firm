...
1. Load `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → class, writing skill level, past feedback patterns.
...
7. Append to `~/.hermes/plugins/config/hermes-the-firm/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `~/.hermes/plugins/config/hermes-the-firm/law-student/PRACTICE.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
- A socratic drill on the rule or issue they're trying to write about (routes to `hermes-the-firm:socratic-drill`)

### Step 5: Track patterns

Append session summary to `~/.hermes/plugins/config/hermes-the-firm/law-student/writing-feedback/[student]/tracker.md`:
...
- **irac-practice:** for IRAC-specific exam essays, `hermes-the-firm:irac-practice` is more targeted
- **socratic-drill:** if the writing issue is that the student doesn't understand the rule, `hermes-the-firm:socratic-drill` on the substantive area first
