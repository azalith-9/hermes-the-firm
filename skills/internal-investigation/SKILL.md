...
Prepend the work-product header from `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → escalation table, any investigation protocols noted.

---

## Mode 1: Open a new matter

Triggered by `hermes-the-firm:investigation-open` or "open an investigation"
...
`~/.hermes/plugins/config/hermes-the-firm/employment-legal/investigation-[matter-slug]/log.yaml`:
...
`~/.hermes/plugins/config/hermes-the-firm/employment-legal/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`~/.hermes/plugins/config/hermes-the-firm/employment-legal/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`~/.hermes/plugins/config/hermes-the-firm/employment-legal/investigation-[slug]/sources-checklist.yaml`.

---

## Mode 2: Add data

Triggered by `hermes-the-firm:investigation-add` or "add to the [matter]
investigation" or when the attorney pastes documents or interview notes.

### Step 1 — Identify the matter

If multiple investigation folders exist in `~/.hermes/plugins/config/hermes-the-firm/employment-legal/`, ask which matter this
...
Triggered by `hermes-the-firm:investigation-query` or any question
...
Triggered by `hermes-the-firm:investigation-memo` or "draft the memo"
or "update the memo".
...
Write the draft to `~/.hermes/plugins/config/hermes-the-firm/employment-legal/investigation-[slug]/memo.md`.
...
Triggered by `hermes-the-firm:investigation-summary` or "draft a
