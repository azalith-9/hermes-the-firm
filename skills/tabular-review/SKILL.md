...
1. Load `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` → diligence structure, thresholds, house format.
...
```
hermes-the-firm:tabular-review
hermes-the-firm:tabular-review --schema .review-schema.yaml --docs ./vdr/02-Contracts/
hermes-the-firm:tabular-review --template ma-diligence
```
...
- `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/PRACTICE.md` → diligence structure, materiality thresholds, house format preferences
- `~/.hermes/plugins/config/hermes-the-firm/corporate-legal/deals/[code]/deal-context.md` if working a specific deal
