---
name: justinian-bar-exam-prep-uk-sqe
...
license: MIT
metadata: " id: justinian.bar-exam-prep-UK-SQE category: justinian jurisdictions: [UK] priority: P0 intent: [sqe, uk bar prep, solicitors, sqa, flk, qualifying-work-experience] related: [justinian-curriculum-builder, justinian-exam-time-management-coach, justinian-flashcards-from-statute, justinian-case-explainer-socratic, justinian-bar-exam-prep-fr-crfpa] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
