...
```
hermes-the-firm:worker-classification
...
Read `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint, any classification history or
prior settlements noted, escalation table, and any house classification
policy the team has recorded.

## Output header

Prepend the work-product header from `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → `## Outputs` (it differs by user role — see `## Who's using this`).
...
If `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` records the company's house classification policy, apply it
...
Escalate per `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` if any of the following, or any team-specific
...
`hermes-the-firm:hiring-review` to review the offer letter, restrictive
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md`. If the Role is **Non-lawyer**:
