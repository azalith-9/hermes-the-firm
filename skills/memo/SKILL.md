...
1. Load `~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → practice areas, jurisdiction.
...
`~/.hermes/plugins/config/hermes-the-firm/legal-clinic/PRACTICE.md` → practice areas, jurisdiction, supervision style.
