...
The user typed `hermes-the-firm:ip-customize`. They want to change something in their
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:ip-cold-start-interview` first —
...
6. **Close.**
   ...
   > run `hermes-the-firm:ip-customize` anytime.
