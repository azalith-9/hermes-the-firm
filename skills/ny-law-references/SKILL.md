...
- federal/UCC text (FDCPA, FCRA, Reg-F, Title 11, model UCC) — served by
  the firm's open-us-law corpus via `us-statute-lookup` (not bundled here;
  see `references/federal-layer.md`)
