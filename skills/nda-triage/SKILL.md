...
<!--
HERMES PORT NOTE
Mechanically ported into hermes-the-firm from HAQQ Legal AI's master-claude-for-legal (MIT), source 'nda-triage.md'.
...
- **Read access** to the folder containing the NDAs (local filesystem in Hermes session, or Drive/iManage/NetDocuments via connector)
