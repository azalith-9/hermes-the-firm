...
license: MIT
metadata: " id: draft.notice-of-arbitration category: draft practice_area: litigation jurisdictions: [UAE, DIFC, ADGM, KSA, LB, GCC, UK, EU, US] priority: P1 intent: [draft, arbitration, notice of arbitration, request for arbitration, commence arbitration] related: [draft-litigation-complaint, draft-mediation-agreement, review-arbitration-clause, draft-statement-of-defense] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
