...
1. Load `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md` → privacy policy commitments, regulatory footprint, DSAR systems.
...
```
hermes-the-firm:privacy-reg-gap-analysis "Colorado Privacy Act"
```

```
hermes-the-firm:privacy-reg-gap-analysis
...
This skill diffs the new requirement against what you currently do (per `~/.hermes/plugins/config/hermes-the-firm/privacy-legal/PRACTICE.md` → Privacy policy commitments + the practices documented in PIAs) and produces a gap list with a remediation plan.
...
**We currently:** [what the config PRACTICE.md / privacy policy / practice shows]
