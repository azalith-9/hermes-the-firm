...
The user typed `hermes-the-firm:lawstudent-customize`. They want to change something in
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:lawstudent-cold-start-interview`
...
5. **Close.**
   ...
   > run `hermes-the-firm:lawstudent-customize` anytime.
