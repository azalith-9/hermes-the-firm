---
name: strategy-legal-market-deep-dive
description: Use when sizing the MENA legal services and legal AI market for investor materials, product prioritisation, or market-entry decisions. Covers total addressable market by country and sub-segment, competitive density by tier, and Louis's targeted share thesis. Internal use only.
license: MIT
metadata: " id: strategy.legal-market-deep-dive category: strategy jurisdictions: [__multi__] priority: P3 intent: [__internal__] related: [strategy-markets, strategy-customers, strategy-competitors, strategy-fundraising, strategy-growth-strategy] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
...
1. **Francophone Africa (OHADA zone):** Algeria, Morocco, Tunisia, Senegal, Côte d'Ivoire. OHADA harmonised commercial law; French-language; many GCC investors active in this region. Louis's French-language capability and civil-law knowledge transfer directly.

2. **MENA–Europe diaspora deals:** Lebanese, Egyptian, and Gulf-family-office structures with European (FR, UK, BE) holding vehicles. Serves Western firms doing MENA-origin deals — familiar counterparties to Louis's Western-firm segment.
