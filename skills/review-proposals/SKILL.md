...
Steps through pending playbook update proposals from the monitor agent and applies approved changes to `~/.hermes/plugins/config/hermes-the-firm/commercial-legal/PRACTICE.md`.
...
4. **For Accept or Edit:** show the exact diff to `~/.hermes/plugins/config/hermes-the-firm/commercial-legal/PRACTICE.md` before writing. Only apply after the attorney explicitly confirms.

5. **For Reject or Defer:** log the decision. Do not modify `~/.hermes/plugins/config/hermes-the-firm/commercial-legal/PRACTICE.md`.
...
```
hermes-the-firm:review-proposals
```
