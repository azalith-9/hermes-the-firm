...
1. **Pending cases (pre-2022)**: administered by DIAC under legacy DIFC-LCIA Rules; DIFC Courts remain supervisory
2. **New disputes arising from pre-2022 contracts**: the clause is ambiguous — it references a dissolved institution. Options:
