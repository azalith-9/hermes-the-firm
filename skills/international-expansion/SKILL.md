...
Read `~/.hermes/plugins/config/hermes-the-firm/employment-legal/PRACTICE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.hermes/plugins/config/hermes-the-firm/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.hermes/plugins/config/hermes-the-firm/employment-legal/expansion-[slug].yaml
...
Run `hermes-the-firm:expansion-update [country]` to update status
as items close.
```
