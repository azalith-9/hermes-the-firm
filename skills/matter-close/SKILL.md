...
5. Append final entry to `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/history.md`.
6. Matter stays in `_log.yaml` and `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/` — not deleted. `/portfolio-status` filters it from active rollups.
...
- `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/matter.md` — reference (intake context)
...
> "I don't see [matter slug] in the matter log. Nothing to close — either the slug is wrong or the matter was never intaken through `hermes-the-firm:matter-intake`. Check the slug first; if it genuinely was never intaken, there's no row to update and no file structure to close."
...
**Before closing the matter (the consequential act — the matter is archived and active tracking ends):** Read `## Who's using this` in `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`. If the Role is Non-lawyer:
...
### Append final entry to `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/history.md`
...
### Touch `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/matters/[slug]/matter.md`
