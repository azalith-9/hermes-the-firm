...
Verbatim text for all federal sources lives in the firm's open-us-law
corpus — quote it via `us-statute-lookup` (`15 USC 1692`, `15 USC 1681`,
`12 CFR 1006`); see `oh-law-references` → `references/federal-layer.md`.
