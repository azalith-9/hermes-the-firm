---
name: wiki-personal-finance-real-estate
description: Use when discussing personal finance strategy, investment frameworks, real estate markets, or tax structuring for MENA-resident professionals — particularly expatriate legal and tech professionals managing assets across UAE, KSA, Lebanon, EU, and US markets. Covers investment principles, UAE/KSA real estate markets, tax considerations for MENA-based professionals, and cross-border asset structuring. Reach for this skill when the user asks about personal investment, real estate purchase in MENA, or tax planning for an expatriate professional in the Gulf.
license: MIT
metadata: " id: wiki.personal-finance-real-estate category: wiki jurisdictions: [UAE, KSA, LB, EU, US, __multi__] priority: P3 intent: [__wiki__, personal-finance, investments, real-estate, tax-structuring, MENA-expat] related: [wiki-real-estate, wiki-finance, wiki-hiring, wiki-geopolitics] source: Louis — HAQQ Legal AI (github.com/sboghossian/mini-hermes-the-firm) version: '1.0'"
---
