...
The user typed `hermes-the-firm:privacy-customize`. They want to change something in
...
1. **Read the config.** Read
   ...
   > You haven't run setup yet. Run `hermes-the-firm:privacy-cold-start-interview`
...
6. **Close.**
   ...
   > run `hermes-the-firm:privacy-customize` anytime.
