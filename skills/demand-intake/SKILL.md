...
1. Load `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` → demand-letter practice, landscape, risk calibration.
...
5. Write `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/demand-letters/[slug]/intake.md`.
6. Confirm with user: "Intake saved. Run `hermes-the-firm:demand-draft [slug]` when ready."
...
- Desired outcome dollar value ≥ the medium-severity band from `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` risk calibration
- Counterparty is a customer, competitor, or frequent adversary per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md` landscape
- User ran with `--full`
...
`[type]-[counterparty-short]-[yyyy-mm]`. Confirm uniqueness in `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/demand-letters/`.

### `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/demand-letters/[slug]/intake.md`
...
End with:
> Intake saved. When ready: `hermes-the-firm:demand-draft [slug]`
...
- Run the conflicts check. If the counterparty is a customer or known entity, flag that this should clear conflicts (per `~/.hermes/plugins/config/hermes-the-firm/litigation-legal/PRACTICE.md`) before sending — but the check itself lives in the matter-intake workflow or outside this skill.
