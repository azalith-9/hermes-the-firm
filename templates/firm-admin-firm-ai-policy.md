...
This policy establishes how [Firm Name] uses generative AI tools (including but not limited to the agent, ChatGPT, Gemini, Copilot, and similar) in the practice of law. It covers permissible uses, mandatory configurations, prohibited uses, supervisory expectations, and client communication standards.
...
|------|---------------|----------------------|
| the agent | Team or Enterprise | IT provisions firm-issued accounts |
...
For agentic work (Hermes session, Hermes Agent, equivalent surfaces), AI sessions must operate within firm-managed directories. AI tools must not be granted unrestricted file system access on personal partitions or volumes containing non-firm data.
...
|------|-----------|-------------------------|--------------|
| the agent (Anthropic) | All listed in §3 | Team / Enterprise tiers; firm-provisioned accounts; connectors per §5.2 | No use on matters with client AI-restriction clauses absent consent |
| [Add others] | | | |
