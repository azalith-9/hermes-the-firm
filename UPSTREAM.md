...
two HAQQ Legal AI skill packs (MIT) and codearranger's Michigan civil-practice
layer (MIT) into one Hermes plugin.
...
- **Upstream repos:**
  ...
  - https://github.com/GalacticPlayground/claude-law
  - Licenses in THIRD-PARTY-NOTICES.md
- **License:** Apache-2.0 (Anthropic) + MIT (HAQQ, codearranger) — see
